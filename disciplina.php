                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="chs">CHS - Carga horário semanal:</label>
                                    <input type="text" class="form-control" name="chs" id="chs">
                                </div>
                                <div class="form-group">
                                    <label for="cht">CHT - Carga horária total:</label>
                                    <input type="text" class="form-control" name="cht" id="cht">
                                </div>                             
                                <div class="form-group">
                                    <label for="chs_ead">CHS EAD - Carga horário semanal EAD:</label>
                                    <input type="text" class="form-control" name="chs_ead" id="chs_ead">
                                </div>                                  
                            </div>
                ...
                <div id="modal_confirmacao" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Exclusão de disciplina</h4>
