...
<html lang="pt-BR">
    <head>    
        ...
        <!-- Others JS Files -->
        <script src="js/pid_professor.js"></script>
                ...
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Exclusão/Cancelamento de atividade do PID</h4>
                            <div id="modal_confirmacao_msg"></div>
                        </div>
                        <div class="modal-body">
                            <div class="alert alert-warning" id="msg_modal_confirmacao">
                                Deseja realmente cancelar/excluir a atividade do PID?
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
