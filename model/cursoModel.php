...
class cursoModel {
    ...
    public function inserir($campos) {
        $sql = "INSERT INTO "
            . "curso(nome,turno,nivel,regime,matriz,id_coordenador,perfil_conclusao,resolucao) "
            . "VALUES ('{$campos['nome']}','{$campos['turno']}','{$campos['nivel']}','{$campos['regime']}','{$campos['matriz']}',{$campos['id_coordenador']},'{$campos['perfil_conclusao']}','{$campos['resolucao']}')";
    ...
    public function atualizar($campos) {
         $sql = "UPDATE curso "
            ...
            . "perfil_conclusao = '{$campos['perfil_conclusao']}', "
    ...
    public function getNivelCursoAluno($id_aluno) {
        $sql = "SELECT
                    curso.nivel
                FROM
                    curso INNER JOIN aluno
