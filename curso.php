                        ...
                        <div class="panel-body">    
                            ...
                            <nav class="nav navbar-form" style="padding-left: 0px">
                                <div class="navbar-left">
                                    ...
                                    <input class="form-control input-sm" type="text" name="registros" id="registros" size="2">
                                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">                                                                                          
                                ...
                                <div class="form-group" id="div_nivel"></div>  
                                <div class="form-group" id="div_turno"></div>
                                <div class="form-group" id="div_regime"></div>
                                <div class="form-group" id="professor"></div> 
                                <div class="form-group">
                                    <label for="matriz">Matriz:</label>
                                    <input type="text" class="form-control" name="matriz" id="matriz">
                                </div>                             
                                <div class="form-group">
                                    <label for="resolucao">Resolução de aprovação:</label>
                                    <input type="text" class="form-control" name="resolucao" id="resolucao">
                                </div>                             
                                <div class="form-group">
                                    <label for="perfil_conclusao">Perfil conclusão:</label>
                                    <textarea rows="5" class="form-control" name="perfil_conclusao" id="perfil_conclusao"></textarea>
                                </div>                                    
                            </div>
