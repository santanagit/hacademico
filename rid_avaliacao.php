...
<html lang="pt-BR">
    <head>    
        ...
        <!-- Others JS Files -->
        <script src="js/rid_avaliacao.js"></script>
    ...
    <body>
        ...
        <form id="formulario">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="horas_planejadas">Horddas Planejadas</label>
                                <input type="text" class="form-control" id="horas_planejadas" name="horas_planejadas">
                            </div>
                            <div class="form-group">
                                <label for="horas_executadas">Horas Executadas</label>
            ...
            Modal histórico
            -->            
            <div id="modal_historico" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header bg-info">
                        ...
                        <div class="modal-body">
                            <div id="div_historico_atividade2"></div>
                        </div>
                        <div class="modal-footer">
