...
function abrirModal(modal, metodo, id_usuario) {
...
function carregarPerfil(){
    ...
    $.ajax({
        ...
        var json = JSON.parse(resposta);
        $('#perfil').append(json.select);
    });
}

function carregarPerfilBusca(){
    $('#metodo').val('carregarPerfilBusca');
    var dados = $('#formulario').serialize();
    $.ajax({
        url: 'controller/' + classe + '.php',
        type: 'post',
        ...
        var json = JSON.parse(resposta);
        $('#perfil_busca').append(json.select);
    });
}
